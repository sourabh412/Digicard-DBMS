...
<head>
    ...
    <title>Digicard - Login</title>
</head>

<body>

    <div class="main-card position-absolute top-50 start-50 translate-middle">
        <img id="login-chip" src="./assets/chip.png" alt="">
            ...
            <div class="container mt-5">
                <form action="./middleware/login.php" method="post">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="password" class="form-control bg-dark text-light" id="exampleInputPassword1" name="pass" required>
                    </div>
